...
;;(define-key viper-vi-basic-map "]]" 'viper-ket-function) ;This makes ]]] go to the beginning of the next function... not ]], perhaps because ] (viper-ket-function) calls ]]...
;;-------------------------------------------------- 
;; My changes
;; Thought I don't really need the put-and-indent commands
;; Whereas, ]] seems pretty useful to me at the moment
;; Will think of adding maybe [] or ][
